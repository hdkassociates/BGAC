          ...
          <div class="page-content">
              ...
              <div class="form-wrapper">
                <div class="form-block w-form">
                  <form id="email-form" action="https://tickets.berniegrantcentre.co.uk/berniegrantartscentre/website/secure/signup.aspx" method="POST" class="form">
                      <input type="hidden" name="ReturnUrl" value="https://www.berniegrantcentre.co.uk/sign-up-result/" />
                      <input name="FirstName" type="text" class="w-input" placeholder="First Name" />
                      <input name="LastName" type="text" class="w-input" placeholder="Last Name" />
                      <input name="Email" type="text" class="w-input" placeholder="Email Address" />
                      <input type="submit" value="Signup" class="submit-button w-button"/>
                  </form>
                </div>
              </div>
          </div>
