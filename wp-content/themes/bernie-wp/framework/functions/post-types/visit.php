...
function create_visit_post_type() {

    $labels = array(
        'name'                => _x( 'Visits', 'Post Type General Name', 'horiondigital' ),
        ...
        'all_items'           => __( 'All Visits', 'horiondigital' ),
...
add_action( 'init', 'create_visit_post_type', 0 );